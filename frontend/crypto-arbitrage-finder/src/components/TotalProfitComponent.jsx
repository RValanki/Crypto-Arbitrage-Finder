...
const TotalProfitComponent = () => {
    return (
        <div className="h-full w-full px-4 flex flex-col items-center md-lg:min-w-[700px] min-w-[500px]">
            ...
            <div className="w-1/2 bg-[#2B2F38] h-[120px] rounded-[5px] p-2">
                <div className="w-full bg-[#373B47] h-full rounded-[5px] flex justify-center items-center"> {/* Center the items */}
                    ...
                    <div className="bg-[#202229] rounded-[5px] md-lg:w-1/3 w-1/2 flex flex-col justify-center items-center mx-2 h-3/4"> {/* Add h-full for full height */}
                        <div className="text-[#28ad46] font-semibold text-xl"> {/* Remove m-8 to prevent additional spacing */}
                            $320.30
                        </div>
                    </div>

                    <div className="bg-[#202229] rounded-[5px] md-lg:w-1/3 w-1/2 flex flex-row justify-center items-center mx-2 h-3/4"> {/* Change to flex-row */}
