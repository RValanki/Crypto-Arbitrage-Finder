        ...
        <div className="w-full h-[10vh] bg-[#2B2F38] rounded-[5px] mb-2.5 p-2 group hover:bg-[#373B47] transition-colors duration-300 ease-in-out cursor-pointer"> {/* Added cursor-pointer */}
            <div className="flex h-full">
                ...
                <div className="flex-[2.5] bg-[#373B47] p-2 rounded-[20px] flex flex-wrap ">
                    ...
                    <div class="flex items-center justify-center text-white font-semibold text-sm ml-2">
                        Profit
                    </div>
                    <div class="flex items-center justify-center bg-[#2B2F38] ml-2 font-bold p-2 my-1 rounded-[5px] text-[#10A91A]">
                        2.3%
                    </div>
                    <div class="flex items-center justify-center text-white font-semibold text-sm ml-2">
                        After fees
